...
(function () {
  ...
  async function doPublish(btn) {
    ...
    try {
      ...
      const PREFIXES = ['cb_', 'title_', 'date_', 'dither_', 'pattern_', 'bg_', 'page_hidden_', 'rank_', 'folder_', 'header_icon_', 'header_text_color_'];
      const data = {};
      ...
      const lines = [
        ...
        "  var VERSION = '" + version + "';",
        "  var PREFIXES = ['cb_', 'title_', 'date_', 'dither_', 'pattern_', 'bg_', 'page_hidden_', 'rank_', 'folder_', 'header_icon_', 'header_text_color_'];",
